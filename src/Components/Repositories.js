...
function Repositories() {
  ...
  return (
    <section>
        <ul className="grid grid-cols-4 gap-4 justify-center my-4">
        {repos?.map(item => (
          ...
          {/* <span>{item.language ? "language:"`${item.language}` : "No language"}</span> */}
          <span className="font-bold">{item.language && "language: " + item.language }</span>
